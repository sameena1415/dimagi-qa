...
from DummyDataGenerationTaks.testPages.base.login_page import LoginPage
from selenium import webdriver
from selenium.webdriver.chrome.service import Service
from webdriver_manager.chrome import ChromeDriverManager
# from DummyDataGenerationTaks.utilities.email_pytest_report import Email_Pytest_Report
...
def driver(settings):
    ...
    login.two_factor_auth(settings["login_username"], settings["login_password"], settings["auth_key"])
    yield driver
    # driver.close()
    driver.quit()
