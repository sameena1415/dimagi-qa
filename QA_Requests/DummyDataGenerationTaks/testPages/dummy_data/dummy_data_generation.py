...
import pandas as pd
import shutil
from DummyDataGenerationTaks.testPages.base.base_page import BasePage
...
from DummyDataGenerationTaks.userInputs.user_inputs import UserData
from DummyDataGenerationTaks.testPages.dummy_data.file_input_output import FileInputOutput
...
class DummyDataGenerationPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.import_cases_from_excel_link = (By.XPATH,"//a[@href='/a/data-engineer-interview/data/edit/import_cases/']")
        ...
        self.case_id_download = (By.XPATH, "(// td[contains(text(), '"+TestData.case_type+"')]/following-sibling::td//a[.//text() = '"+TestData.file_name+"'])[1]")
    ...
    def excel_download(self):
        ...
        new_file = latest_download_file()
        print("File: " + new_file + " successfully downloaded")
        assert new_file == TestData.file_name
