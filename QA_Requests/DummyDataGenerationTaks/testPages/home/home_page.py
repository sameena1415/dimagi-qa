...
class HomePage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.available_application = UserData.data_application
        ...
        self.application_path = (By.LINK_TEXT, UserData.data_application)
        ...
        self.APP_TITLE = "Releases - " + UserData.data_application + " - CommCare HQ"
