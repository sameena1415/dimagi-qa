...
from CommcareHQ.UserInputs import inputs
...
class ExportDataPage:
    ...
    def daily_saved_exports_form(self):
        ...
        if inputs.form_export_name in self.driver.page_source:  # this condition can be improvised
    ...
    def daily_saved_exports_case(self):
        ...
        if inputs.case_export_name in self.driver.page_source:  # this condition can be improvised
