...
class OrganisationStructurePage:
    ...
    def __init__(self, driver):
        ...
        self.additional_info_drop_down = "//*[@id='select2-id_data-field-"+fetch_location_field()+"-container']"
        self.select_value_drop_down = "//li[text()='"+fetch_location_field()+"']"
    ...
    def edit_location_fields(self):
        ...
        self.driver.find_element(By.XPATH, self.loc_property_xpath).send_keys(fetch_location_field())
        self.driver.find_element(By.XPATH, self.loc_label_xpath).clear()
        self.driver.find_element(By.XPATH, self.loc_label_xpath).send_keys(fetch_location_field())
        self.driver.find_element(By.XPATH, self.add_choice_btn_xpath).click()
        self.driver.find_element(By.XPATH, self.choice_xpath).send_keys(fetch_location_field())
    ...
    def create_org_level(self):
        ...
        self.driver.find_element(By.XPATH, self.org_level_value_xpath).send_keys(UserInputs.loc_level)
