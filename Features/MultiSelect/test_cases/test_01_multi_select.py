...
def test_case_04_multiselect_enabled_select_parent_first(driver, settings):
    multiselect = MultiSelectWorkflows(driver)
...
def test_case_05_multiselect_with_select_parent_first_as_parent(driver, settings):
    webapps = WebApps(driver)
    multiselect = MultiSelectWorkflows(driver)
    menu = HomePage(driver, settings)
    menu.applications_menu(MultiSelectUserInput.multiselect_app_name)
...
def test_case_06_multiselect_disabled_select_parent_first(driver):
    webapps = WebApps(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
    webapps.open_app(MultiSelectUserInput.multiselect_app_name)
...
def test_case_07_parent_multi_child_nonmulti(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
...
def test_case_08_parent_multi_child_multi(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
...
def test_case_09_parent_nonmulti_child_multi(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
...
def test_case_10_parent_nonmulti_child_nonmulti(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
...
def test_case_11_multiselect_with_shadow_menus(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    casesearch = CaseSearchWorkflows(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
    ...
    casesearch.check_eof_navigation(eof_nav=MENU,
                                    menu=MultiSelectUserInput.Shows_MS_SPFP)
...
def test_case_12_multiselect_form_linking(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    casesearch = CaseSearchWorkflows(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
...
def test_case_13_multiselect_with_case_search_workflows(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
    webapps.open_app(MultiSelectUserInput.multiselect_app_name)
...
def test_case_14_multiselect_with_display_only_forms(driver):
    multiselect = MultiSelectWorkflows(driver)
    webapps = WebApps(driver)
    webapps.login_as(CaseSearchUserInput.user_1)
    webapps.open_app(MultiSelectUserInput.multiselect_app_name)
