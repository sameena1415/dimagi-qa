...
class ProjectSettingsPage(BasePage):
    ...
    def set_inactivity_timeout(self):
        self.wait_to_click(self.manage_settings)
        self.wait_to_click(self.project_settings_link)
        self.wait_to_click(self.privacy_security)
        self.wait_for_element(self.inactivity_timeout)
        self.wait_to_click(self.shortened_inactivity)
        time.sleep(2)
