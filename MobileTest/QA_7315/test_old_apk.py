...
app_path = 'C:\\Users\\dsi-user\\PycharmProjects\\Anroid\\apps\\commcare_2.53.1.apk'
capabilities = UiAutomator2Options().load_capabilities({
    "platformName": "Android",
    "udid": "emulator-5556",
    "automationName": "UIAutomator2",
    "deviceName": "Pixel_8_Old_APK",
    "avd": "Pixel_8_Old_APK",
...
class TestAppium(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.radio_btn_field = "//*[@text='mumbai']"
        ...
        self.payment_verification_job = (AppiumBy.XPATH,
                                         "//android.widget.TextView[@text=\"Payment Verifications\"]//following-sibling::android.widget.ImageView[@resource-id=\"org.commcare.dalvik:id/button\"]\n")
    ...
    def test_form_submission(self) -> None:
        ...
        time.sleep(25)
        self.driver.find_element(AppiumBy.ID, self.username).send_keys('04')
